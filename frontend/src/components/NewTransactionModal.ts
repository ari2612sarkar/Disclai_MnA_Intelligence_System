...
export class NewTransactionModal {
  ...
  private render() {
    ...
    (this.overlay.querySelector('#txn-name') as HTMLInputElement)?.focus();
  }
  ...
  private bindEvents() {
    ...
    form?.addEventListener('submit', async (e) => {
      ...
      const data = {
        ...
        deal_value: formData.get('deal_value') ? parseFloat(formData.get('deal_value') as string) : undefined,
